    ...
    public class GameSession
    {
        ...
        public bool MovePlayer(string playerId, int newX, int newY)
        {
            ...
            bool isTargetTraversable = (targetTile == TileType.Empty ||
                                       ...
                                       targetTile == TileType.Explosion); // Allow moving onto explosion (player might die in DetonateBomb)
            ...
            {
                player.MaxBombs++;
                // Console.WriteLine($"--- Player {player.Id} picked up PowerUpBombCount! MaxBombs: {player.MaxBombs} ---"); // Removed
            }
            else if (targetTile == TileType.PowerUpBlastRadius)
            {
                player.BlastRadius++;
                // Console.WriteLine($"--- Player {player.Id} picked up PowerUpBlastRadius! BlastRadius: {player.BlastRadius} ---"); // Removed
            }
