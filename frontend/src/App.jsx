...
export default function App() {
  ...
  // Tastatur‐hendelser (W/A/S/D, Space, P)
  useEffect(() => {
      ...
      <div className="main">
        ...
        <aside className="sidebar">
          ...
          <div className="legend">
            <h3>Farge-legende</h3>
            <ul>
              <li><span className="legend-box wall-fixed"></span> Indestruktibel vegg</li>
              <li><span className="legend-box wall-dest"></span> Sprengbar vegg</li>
              <li><span className="legend-box empty"></span> Tomt felt</li>
              <li><span className="legend-box player"></span> Spilleren</li>
              <li><span className="legend-box bomb"></span> Bombe (eksploderer om {bombTimer}s)</li>
              <li><span className="legend-box explosion"></span> Eksplosjon</li>
            </ul>
          </div>
        </aside>
      </div>
